...
class ParametersAWSState extends State<ParametersAWS> {
  ...
  List<String> currentDiscTimes = [];
  List<String> currentConnecTimes = [];
  ...
  Future<void> loadEquipmentData() async {
    if (productCode.isNotEmpty && serialNumberController.text.isNotEmpty) {
      ...
      setState(() {
        ...
        currentDiscTimes = List.from(discTimes);
        currentConnecTimes = List.from(connecTimes);
        currentConnection = isConnectedToAWS;
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                icon: _isLoading
                    ...
                    : const Icon(Icons.search, color: color4),
                label: Text(
                  _isLoading ? 'Buscando...' : 'Buscar datos del equipo',
                  style: const TextStyle(
                    color: color4,
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
            ...
            if (_isLoading) ...[
              ...
              buildText(
                ...
                textSpans: [
                  const TextSpan(
                    text: 'Estado de conexión a la nube:\n',
                    style:
                        TextStyle(color: color4, fontWeight: FontWeight.bold),
                  ),
                  TextSpan(
                    text: currentConnection ? 'Conectado' : 'Desconectado',
                    style: TextStyle(
                      color: currentConnection ? Colors.green : Colors.red,
                      fontWeight: FontWeight.bold,
                    ),
                  ),
                ],
                ...
                textSpans: [
                  ...
                  TextSpan(
                    text: currentDistanceControlActive
                        ...
                        : 'Desactivado',
                    style: TextStyle(
                        color: currentDistanceControlActive
                            ? Colors.green
                            : Colors.red,
                        fontWeight: FontWeight.bold),
                  ),
              ...
              if (currentDistanceControlActive) ...[
                ...
                buildButton(
                  ...
                  onPressed: () {
                    putDistanceControl(
                        productCode, serialNumberController.text.trim(), false);
                    registerActivity(
                      productCode,
                      serialNumberController.text.trim(),
                ...
                textSpans: [
                  ...
                  TextSpan(
                    text: currentOwner == ''
                        ...
                        : currentOwner,
                    style: TextStyle(
                      color: currentOwner == '' ? Colors.red : Colors.green,
                      fontWeight: FontWeight.bold,
                    ),
                  ),
                ],
                    ...
                    children: [
                      ...
                      if (currentSecondaryAdmins.isEmpty) ...[
                        Container(
                          ...
                          child: const Row(
                            children: [
                              Icon(Icons.info_outline, color: color3, size: 24),
                              SizedBox(width: 10),
                              Expanded(
                                child: Text(
                          ...
                          Container(
                            ...
                            child: ListTile(
                              ...
                              leading: CircleAvatar(
                                backgroundColor: color1,
                                child: Text(
                                  currentSecondaryAdmins[i][0].toUpperCase(),
                                  style: const TextStyle(
                                    color: color4,
                                    fontWeight: FontWeight.bold,
                                  ),
              ...
              buildText(
                ...
                textSpans: [
                  ...
                  TextSpan(
                    ...
                    style: TextStyle(
                        color: currentSecAdmDate ==
                                'No tiene activado este beneficio'
                            ? Colors.red
                            : Colors.yellow,
                        fontWeight: FontWeight.bold),
                  ),
                          ...
                          TextButton(
                            onPressed: () {
                              ...
                              putDate(
                                  ...
                                  false);
                              setState(() {
                                currentSecAdmDate = dateController.text.trim();
                              });
                              navigatorKey.currentState!.pop();
                            },
                            child: const Text(
              ...
              buildText(
                ...
                textSpans: [
                  ...
                  TextSpan(
                    ...
                    style: TextStyle(
                        color:
                            currentAtDate == 'No tiene activado este beneficio'
                                ? Colors.red
                                : Colors.yellow,
                        fontWeight: FontWeight.bold),
                  ),
                    ...
                    child: Column(
                      children: [
                        Icon(
                          ...
                          size: 48,
                          color:
                              currentRiegoMaster.isNotEmpty ? color1 : color3,
                        ),
                        const SizedBox(height: 10),
                        buildText(
                          text: '',
              ...
              if (currentDiscTimes.isNotEmpty) ...[
                const SizedBox(height: 20),
                    ...
                    child: ExpansionTile(
                      ...
                      title: Row(
                        children: [
                          ...
                          Text(
                            'Desconexiones (${currentDiscTimes.length})',
                            style: const TextStyle(
                              color: color4,
                              fontWeight: FontWeight.bold,
                              fontSize: 16,
                      ...
                      children: [
                        ...
                        for (int i = currentDiscTimes.length - 1;
                            i >= 0;
                            i--) ...[
                          Padding(
                            padding: const EdgeInsets.symmetric(
              ...
              if (currentConnecTimes.isNotEmpty) ...[
                const SizedBox(height: 20),
                FractionallySizedBox(
                  alignment: Alignment.center,
                  widthFactor: 0.9,
                    ...
                    child: ExpansionTile(
                      ...
                      title: Row(
                        children: [
                          ...
                          const SizedBox(width: 8),
                          Text(
                            'Conexiones (${currentConnecTimes.length})',
                            style: const TextStyle(
                              color: color4,
                              fontWeight: FontWeight.bold,
                              fontSize: 16,
                      ...
                      children: [
                        const Divider(color: color1, height: 1, thickness: 1),
                        for (int i = currentConnecTimes.length - 1;
                            i >= 0;
                            i--) ...[
                          Padding(
                            padding: const EdgeInsets.symmetric(
                            ...
                            child: () {
                              final dateTime =
                                  DateTime.fromMillisecondsSinceEpoch(
                                      int.parse(currentConnecTimes[i]));
                              final date =
                                  '${dateTime.year}/${dateTime.month.toString().padLeft(2, '0')}/${dateTime.day.toString().padLeft(2, '0')}';
                              final time =
                                  '${dateTime.hour.toString().padLeft(2, '0')}:${dateTime.minute.toString().padLeft(2, '0')}:${dateTime.second.toString().padLeft(2, '0')}';
